...
(function() {
  ...
  levels = [
    (new Level()).setStageSize(w, h).setPlayer(player).setPlanets([new Planet(-100, -450, 60), new Planet(100, -700, 70), new Planet(300, -1000, 100), new Planet(-50, 150, 100), new Sun(600, -600, 100)]).setGoal(new Planet(800, -850, 60)).setPosition({
      x: 0,
      y: 0
    }).setOxygen(1000).setJump(40), (new Level()).setStageSize(w, h).setPlayer(player).setPlanets([new Planet(200, -150, 60), new Planet(100, 700, 70), new Planet(-100, -400, 100), new Planet(-50, 50, 70), new Sun(100, 300, 100)]).setGoal(new Planet(-100, -950, 60)).setPosition({
      x: 100,
      y: 600
