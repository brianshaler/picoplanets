...
(function() {
  var Chrome, Galaxy, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_SPACE, KEY_UP, Level, MODE_DEAD, MODE_FINISH, MODE_PLAY, MODE_START, Mass, Planet, Player, Sun, canvas, chrome, currentLevel, death, finish, getColor, h, key_dir, levels, planets, playMode, player, rotation, runningOutColors, setPixel, startGame, w,
  ...
  Player = (function() {
    ...
    Player.prototype.death = function() {
      return radio(this.DEAD).broadcast();
    };

    Player.prototype.finished = function() {
      return radio(this.FINISHED).broadcast();
    };
  ...
  Level = (function() {
    ...
    Level.prototype.setStageSize = function(w, h) {
      this.w = w;
      this.h = h;
    ...
    Level.prototype.setPlanets = function(planets) {
    ...
    Level.prototype.setPosition = function(sp) {
      this.startingPosition.x = sp.x;
      this.startingPosition.y = sp.y;
      return this;
    };
    ...
    Level.prototype.redraw = function(s) {
      ...
      this.rotation += (idealRotation - this.rotation) * .1;
      if (this.rotation < 0) {
  ...
  levels = [
    (new Level()).setStageSize(w, h).setPlayer(player).setPlanets([new Planet(-100, -450, 60), new Planet(100, -700, 70), new Planet(300, -1000, 100), new Planet(-50, 150, 100), new Sun(600, -600, 100)]).setGoal(new Planet(800, -850, 60)).setPosition({
      x: 0,
      y: -300
    }).setOxygen(1000).setJump(40), (new Level()).setStageSize(w, h).setPlayer(player).setPlanets([new Planet(100, -450, 60), new Planet(-100, -700, 70), new Planet(-300, -1000, 100), new Planet(50, 150, 100), new Sun(-600, -600, 100)]).setGoal(new Planet(-800, -850, 60)).setPosition({
      x: 0,
      y: -300
    }).setOxygen(1000).setJump(40)
  ];
