...
(function() {
  ...
  Chrome = (function() {
    ...
    Chrome.prototype.intro = function(s) {
      ...
      this.starsCounter++;
      speed = 0.01;
      this.starsX = ((Math.sin(this.starsCounter * speed)) + 1) / 2 * -(1000 - this.w - 0) - this.w / 2;
      this.starsY = ((Math.sin(this.starsCounter * speed)) + 1) / 2 * -(1000 - this.h - 0) / 10 - this.h / 2;
      this.s.image(this.s.stars, this.starsX, this.starsY);
      this.s.rotate(-0.1);
      this.s.translate(-this.w / 2, -this.h / 2);
