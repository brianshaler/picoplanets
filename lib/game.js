...
(function() {
  ...
  Player = (function() {
    ...
    function Player() {
      ...
      cb = function() {
        cnt++;
        if (cnt > 0) {
          _this.walkingImage = _this.IMG_WALKING;
        } else {
          _this.walkingImage = _this.IMG_STANDING;
        }
        if (cnt > 3) {
          return cnt = 0;
        }
    ...
    Player.prototype.maxJump = 50;

    Player.prototype.minJump = 5;
    ...
    Player.prototype.move = function() {
      ...
      if (this.onGround && !this.jumping) {
        if (this.velocityX + this.velocityY > 2) {
  ...
  sketch(function() {
    ...
    this.setup = function() {
      ...
      console.log(_this.ARGB);
      console.log(_this.stars.pixels);
