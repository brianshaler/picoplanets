...
(function() {
  var Chrome, Galaxy, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_SPACE, KEY_UP, Level, MODE_DEAD, MODE_FINAL, MODE_FINISH, MODE_INTRO, MODE_PLAY, MODE_START, Mass, Planet, Player, Sun, canvas, chrome, ctx, currentLevel, death, finish, getColor, h, key_dir, levels, planets, playMode, player, rotation, runningOutColors, setPixel, starBrightness, startGame, startOver, w,
