...
(function() {
  var Chrome, Galaxy, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_SPACE, KEY_UP, MODE_DEAD, MODE_FINISH, MODE_PLAY, MODE_START, Mass, Planet, Player, Sun, canvas, chrome, death, finish, galaxy, h, key_dir, planet, planets, playMode, player, rotation, setPixel, startGame, w, _i, _len,
  ...
  sketch(function() {
    ...
    return this.draw = function() {
      var diff, idealRotation, nearestPlanet, txt;
      _this.background(0);
      switch (playMode) {
        case MODE_START:
